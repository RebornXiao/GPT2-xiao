    ...
    for filename in filenames:
        ...
        try:
            with open(os.path.join(data_path, filename), 'r', encoding='utf8') as f:
                ...
                text = tokenizer.convert_ids_to_tokens(line)
                ...
                text = text.replace('】','')
                print('reading ok')
            with open(os.path.join(data_path, filename.split(".")[0]+text+".txt"), 'w', encoding='utf8') as f:
                f.write(text)
