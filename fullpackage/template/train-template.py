...
logg = logger('template.log', logging.INFO, logging.INFO)
...
def main():
    ...
    parser.add_argument('--raw_data_path', default='data_template', type=str, required=False, help='原始训练语料')
    parser.add_argument('--tokenized_data_path', default='data_template/tokenized/', type=str, required=False,
    ...
    parser.add_argument('--output_dir', default='model_template/', type=str, required=False, help='模型输出路径')
